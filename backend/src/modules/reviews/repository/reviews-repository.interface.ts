...
export interface IReviewsRepository {
  ...
  findByOwner(ownerType: OwnerType, ownerId: string, pagination?: ReviewPagination, tx?: unknown): Promise<Review[]>;
  findApproved(filters?: ReviewFilters, pagination?: ReviewPagination, tx?: unknown): Promise<Review[]>;
  findPending(filters?: ReviewFilters, pagination?: ReviewPagination, tx?: unknown): Promise<Review[]>;
...
export interface IFavoritesRepository {
  ...
  findByOwner(ownerType: OwnerType, ownerId: string, pagination?: FavoritePagination, tx?: unknown): Promise<Favorite[]>;
  countByOwner(ownerType: OwnerType, ownerId: string, tx?: unknown): Promise<number>;
  findMany(options: {
    filters?: FavoriteFilters;
    pagination?: FavoritePagination;
  }, tx?: unknown): Promise<Favorite[]>;
